...
const TeacherLayout: React.FC = () => {
  ...
  const menuItems = [
    ...
    { text: 'Create Assignment', icon: <Assignment />, path: '/create-assignment' },
    { text: 'Grade Submissions', icon: <Grade />, path: '/grade' },
    { text: 'Analytics', icon: <Analytics />, path: '/analytics' },
    { text: 'Assignment Bank', icon: <LibraryBooks />, path: '/assignment-bank' },
  ];
            ...
            <ListItem key={item.text} disablePadding sx={{ mb: 0.5 }}>
              <ListItemButton
                ...
                sx={{
                  ...
                  color: isActive ? theme.palette.warning.main : theme.palette.text.primary,
                  '&:hover': {
      ...
      >
        <Toolbar sx={{ minHeight: '64px !important' }}>
          ...
          <Typography variant="h6" noWrap component="div" sx={{ fontWeight: 600, fontSize: '1.125rem' }}>
            {menuItems.find(item => item.path === location.pathname)?.text || 'Teacher Portal'}
          </Typography>
        </Toolbar>
      </AppBar>
